defmodule UndiOnlineWeb.OnboardingLiveTest do
  use UndiOnlineWeb.ConnCase

  import Phoenix.LiveViewTest

  def setup_onbarding_account(%{conn: conn, user: user}) do
    account = UndiOnline.Users.with_personal_account(user).personal_account
    UndiOnline.Accounts.update_account(account, %{onboarding_required: true})
