defmodule UndiOnline.UserIdentitiesTest do
  use UndiOnline.DataCase

  import UndiOnline.UsersFixtures
  import UndiOnline.UserIdentitiesFixtures

  alias UndiOnline.UserIdentities
  alias UndiOnline.UserIdentities.UserIdentity
  ...
  describe "find_or_create_user with a new user_identity" do
    test "find_or_create_user/1 it returns ok-account-tuple" do
      ...
      assert {:just_created, %UndiOnline.Users.User{email: "new_user@example.com"}} =
