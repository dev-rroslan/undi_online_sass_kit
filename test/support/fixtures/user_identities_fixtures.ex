defmodule UndiOnline.UserIdentitiesFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `UndiOnline.UserIdentities` context.
  """
  ...
  def user_identity_fixture(%User{} = user, attrs) do
    ...
    {:ok, user_identity} = UndiOnline.UserIdentities.create_user_identity(user, attrs)
