defmodule UndiOnline.Campaigns do
  @moduledoc """
  ...
  alias UndiOnline.Campaigns.Membership
  alias UndiOnline.Campaigns.Receipt
  alias UndiOnline.Campaigns.ExecuteStepWorker
  ...
  def get_campaign_module(:campaign_only_used_in_test), do: UndiOnline.CampaignsTest.TestCampaign
  def get_campaign_module("campaign_only_used_in_test"), do: UndiOnline.CampaignsTest.TestCampaign
  ...
  def not_in_campaign_query(query, campaign) do
    in_campaign_subquery = from(
      m in UndiOnline.Campaigns.Membership,
